  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          CortexOS ran into an unexpected error. Try again or head home.
        </p>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "CortexOS — Build Your AI Organization" },
      {
        name: "description",
        content:
      ...
      { name: "author", content: "CortexOS" },
      { property: "og:title", content: "CortexOS — Build Your AI Organization" },
      {
